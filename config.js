...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://graph.org/file/56c0fb63b1eb1b2ca789c.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923321709439-1632403322@g.us',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Mr Bot;Skl11;0;https://graph.org/file/56c0fb63b1eb1b2ca789c.jpg;https://chat.whatsapp.com/Fc97ajkg5DvBbSGYfmRU8M',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Bot",
    BOT_NAME: process.env.BOT_NAME || 'Mr Bot',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Mr Bot;https://graph.org/file/56c0fb63b1eb1b2ca789c.jpg' : process.env.AUDIO_DATA,
